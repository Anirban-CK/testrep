...
export class HomePage extends BasePage {
  ...
  private readonly shoppingCartBadge: Locator = this.page.locator(
    ".shopping_cart_badge"
  );
  private readonly hamburgerMenu: Locator = this.page.locator(
    "#react-burger-menu-btn"
  );
  private readonly logoutLink: Locator = this.page.locator(
    "#logout_sidebar_link"
  );
  private readonly addToCartButtons: Locator = this.page.locator(
  ...
  async addItemToCart(itemIndex: number = 0): Promise<void> {
    ...
    await this.click(
      this.addToCartButtons.nth(itemIndex),
